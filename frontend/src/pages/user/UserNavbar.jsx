...
import { Bell, Sun, Moon, Globe, ChevronDown, Menu } from "lucide-react";
import NotificationDropdown from "../../components/NotificationDropdown";
import { useAuth } from "../../context/AuthContext";
import { useTheme } from "../../context/ThemeContext";
import { motion, AnimatePresence } from "framer-motion";

const UserNavbar = ({ onToggle, isSidebarOpen }) => {
  const { user } = useAuth();
      ...
      <div className="flex items-center gap-1.5 sm:gap-4">
        ...
        <div className="flex items-center gap-3 border-l border-slate-200 dark:border-slate-700 pl-4">
          <div className="text-right hidden sm:block">
            ...
            <p className="text-[10px] text-slate-500 dark:text-slate-400 font-semibold uppercase mt-1 tracking-wider italic">Citizen</p>
          </div>
